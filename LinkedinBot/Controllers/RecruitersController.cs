...
namespace LinkedinBot.Controllers
{
    ...
    {
        private readonly LinkedinBotContext _context;

        public RecruitersController(LinkedinBotContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Recruiter != null ?
                        ...
                        Problem("Entity set 'LinkedinBotContext.Recruiter'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Country,ProfileLink,ConectedProfile,FirstMessageSended,IsPrivateProfile")] Recruiter recruiter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Country,ProfileLink,ConectedProfile,FirstMessageSended,IsPrivateProfile")] Recruiter recruiter)
        {
            if (id != recruiter.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LinkedinBotContext.Recruiter'  is null.");
            }
            var recruiter = await _context.Recruiter.FindAsync(id);
            if (recruiter != null)
            {
